            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <div class="mt-5">
                                <h4 class="card-title float-left mt-2">Tài Khoản Khách Hàng</h4>
                                <a href="add-leave-type.html" class="btn btn-primary float-right veiwbutton">Thêm tài khoản khách hàng
                                    </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover table-center mb-0">
                                        ...
                                        <tbody>
                                        <?php
										$sql = "SELECT * FROM taikhoan,khachhang where taikhoan.kh_id =khachhang.kh_id order by tk_id desc";
										...
										while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            <td><a href="tk_view.php?this_id=<?php echo $row['tk_id'] ?>">#<?php echo $row['tk_id']; ?></td>
                                                ...
                                                <a href="tk_view.php?this_id=<?php echo $row['tk_id']; $_SESSION['kh']= $row['kh_id']; ?>">
													...
													<a href="tk_kh_sua.php?this_id=<?php echo $row['tk_id'] ?>">
