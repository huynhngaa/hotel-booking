...
if(isset($_POST['luu'])){
	...
	$sql = "INSERT INTO nhanvien(nv_id,nv_ten,nv_hinhanh,nv_sdt,nv_email,nv_diachi)
	VALUES ('$id','$name','$hinhanh','$sdt','$email','$diachi')";
	mysqli_query($conn,$sql);
	move_uploaded_file( $hinhanh_tmp_name, 'assets/img/profiles/'. $hinhanh);
	// $sq = "INSERT INTO taikhoan(tk_id,tk_username,tk_password,tk_level,nv_id)
							...
							<div class="row formtype">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input name="ngsinh" type="text" class="form-control" id="usr"> </div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label>Số Điện Thoại</label>
